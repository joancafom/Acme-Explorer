...
<form:form action="message/explorer/edit.do" modelAttribute="messageEdit">
		...
		<jstl:if test="${messageEdit.id==0}">
			...
			<input type="button" name="cancel" value="Cancel" onclick="javascript: relativeRedir('folder/explorer/list.do');" />
