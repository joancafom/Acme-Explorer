...
<display:table name="messages" id="message" requestURI="message/${url}list.do?folderId=${folderId}" class="displaytag">
	...
	<display:column >
		<a href="message/${url}display.do?messageId=${message.id}">Details</a>
		<a href="message/${url}edit.do?messageId=${message.id}">Edit</a>
	</display:column>
</display:table>