...
<form:form action="tag/admin/edit.do" modelAttribute="tag">
	...
	<jstl:if test="${empty tag.tagValues}">
		<form:label path="name"><spring:message code="tag.name"/></form:label>
	...
	<input type="button" name="cancel" value="<spring:message	code="tag.cancel" />" onclick="javascript: relativeRedir('tag/admin/list.do');" />
</form:form>