...
@Controller
@RequestMapping("/audit/sponsor")
public class AuditSponsorController extends AbstractController {
	...
	public ModelAndView list(@RequestParam final int tripId) {
		...
		result.addObject("actorWS", "sponsor/");
