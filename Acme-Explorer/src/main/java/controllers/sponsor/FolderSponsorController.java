...
@Controller
@RequestMapping("/folder/sponsor")
public class FolderSponsorController extends AbstractController {
	...
	public FolderSponsorController() {
		super();
	}
	...
	public ModelAndView list(@RequestParam(required = false) final Integer folderId) {
		...
		String requestURI = "folder/sponsor/list.do?folderId=";
	...
	public ModelAndView save(@Valid final Folder folder, final BindingResult binding) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/folder/sponsor/list.do");
