...
@Controller
@RequestMapping("/curriculum/admin")
public class CurriculumAdminController extends AbstractController {
	...
	public ModelAndView display(@RequestParam final int curriculumId) {
		...
		res.addObject("RequestURI", "curriculum/admin/display.do?curriculumId=" + curriculum.getId());
