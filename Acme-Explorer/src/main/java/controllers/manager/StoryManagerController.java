...
@Controller
@RequestMapping("/story/manager")
public class StoryManagerController extends AbstractController {
	...
	public ModelAndView list(@RequestParam final int tripId) {
		...
		res.addObject("requestURI", "story/manager/list.do");
