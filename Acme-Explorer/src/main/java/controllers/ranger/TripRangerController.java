...
@Controller
@RequestMapping("/trip/ranger")
public class TripRangerController extends AbstractController {
	...
	public ModelAndView list(@RequestParam(required = false) final String keyword, @RequestParam(required = false) final Integer categoryId) {
		...
		res.addObject("requestURI", "/trip/ranger/list.do");
		res.addObject("actorWS", "ranger/");
	...
	public ModelAndView display(@RequestParam final int tripId) {
		...
		res.addObject("requestURI", "trip/ranger/display.do?tripId=" + tripId);
