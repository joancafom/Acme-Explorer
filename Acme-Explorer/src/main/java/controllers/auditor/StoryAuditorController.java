...
@Controller
@RequestMapping("/story/auditor")
public class StoryAuditorController extends AbstractController {
	...
	public ModelAndView list(@RequestParam final int tripId) {
		...
		res.addObject("requestURI", "story/auditor/list.do");
		res.addObject("tripURI", "trip/auditor/display.do?tripId=");
