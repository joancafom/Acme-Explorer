...
@Controller
@RequestMapping("/curriculum/auditor")
public class CurriculumAuditorController extends AbstractController {
	...
	public CurriculumAuditorController() {
		super();
	}
	...
	public ModelAndView display(@RequestParam final int curriculumId) {
		...
		res.addObject("RequestURI", "curriculum/auditor/display.do?curriculumId=" + curriculum.getId());
