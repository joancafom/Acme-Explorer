...
@Controller
@RequestMapping("/audit/explorer")
public class AuditExplorerController extends AbstractController {
	...
	public AuditExplorerController() {
		super();
	}
	...
	public ModelAndView list(@RequestParam final int tripId) {
		...
		result.addObject("actorWS", "explorer/");
